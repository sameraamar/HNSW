...
namespace HNSW
{
    ...
    public partial class SmallWorld<TItem, TDistance> where TDistance : struct, IComparable<TDistance>
    {
        ...
        public Parameters Param => Graph.Parameters;
        ...
        /// <summary>
        /// Gets a copy of the list of item IDs currently held by the SmallWorld graph. 
        ...
        public IReadOnlyList<int> ItemIds
        {
            get
            {
                ...
                try
                {
                    return Graph.GraphCore.Nodes.Select(n => n.Id).ToList();
                }
                finally
                {
        ...
        public void SetParameterInitialDistanceCacheSize(int size)
        {
            Graph.SetParameterInitialDsitanceCasheSize(size);
        }
        ...
        public class Parameters
        {
            ...
            private double _levelLambda = 0.0;
